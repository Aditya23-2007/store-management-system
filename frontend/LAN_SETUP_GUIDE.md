...
This client application can be run locally on any PC as a native desktop application, or rendered directly inside your web browser, connecting to the backend server running on the network.
...
### Option B: Run as a Standalone Desktop Client
